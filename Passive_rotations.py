...
def bras_en_haut(m, x0, t, T0, Tf, Q0, Qf):
    ...
    return dynamics_root(m, x0, Qddot_J)[0]  # le tuple en sortie
...
def bras_descendent(m, x0, t, T0, Tf, Q0, Qf):
    ...
    return dynamics_root(m, x0, Qddot_J)[0]  # le tuple en sortie de dynamics_root
...
simuler("JeCh", m_JeCh, N, t0, tf, T0, Tf, Q0, Qf, X0, action_bras=bras_descendent, viz=True)  # weird stuff a gauche
simuler("JeCh", m_JeCh, N, t0, tf, T0, Tf, Q0, Qf, X0, action_bras=bras_gauche_descend, viz=True)  # idem
