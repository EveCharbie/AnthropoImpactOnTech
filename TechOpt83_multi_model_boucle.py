...
def set_x_bounds(biorbd_model, fancy_names_index, final_time):
    ...
    bassin_Q_func = cas.Function(
        "bassin_Q_func", [CoM_Q_sym], [biorbd_model[0].globalJCS(0).to_mx()]
    ...
    x_bounds[1].max[fancy_names_index["Xrot"], :] = -0.50 + 4 * 3.14
    ...
    x_bounds[2].max[fancy_names_index["Xrot"], :] = -0.50 + 4 * 3.14
    ...
    x_bounds[2].max[fancy_names_index["Zrot"], :] = 3.14
    ...
    x_bounds[3].max[fancy_names_index["Zrot"], :] = 5 * 3.14
...
def set_x_init(biorbd_model, fancy_names_index):
    ...
    x2[fancy_names_index["Zrot"], 1] = 0.2  # 3.14
    ...
    x3[fancy_names_index["Zrot"], 0] = 0  # 3.14
...
def prepare_ocp(
    ...
    ## JeCh
    objective_functions.add(
        ObjectiveFcn.Mayer.MINIMIZE_TIME, min_bound=0.0, max_bound=final_time, weight=100000, phase=5
    )
...
def main():
    ...
    model_path_JeCh = "Models/AuJo_TechOpt83.bioMod"
    n_threads = 4
    ...
    #               40, 100, 100, 100, 40)
    n_shooting = (4, 10, 10, 10, 4, 4, 10, 10, 10, 4)
