...
def set_x_bounds(biorbd_model, fancy_names_index, final_time):
    ...
    zmax = 8
    # 9.81 / 8 * final_time**2 + 1  # une petite marge

    # deplacement
    x_bounds[0].min[fancy_names_index["X"], :] = -0.1
    x_bounds[0].max[fancy_names_index["X"], :] = 0.1
    x_bounds[0].min[fancy_names_index["Y"], :] = -1.0
    x_bounds[0].max[fancy_names_index["Y"], :] = 1.0
    ...
    x_bounds[0].min[fancy_names_index["Xrot"], DEBUT] = 0.50  # penche vers l'avant un peu carpe
    x_bounds[0].max[fancy_names_index["Xrot"], DEBUT] = 0.50
    x_bounds[0].min[fancy_names_index["Xrot"], MILIEU:] = 0
    x_bounds[0].max[fancy_names_index["Xrot"], MILIEU:] = 4 * 3.14 + 0.1  # salto
    ...
    x_bounds[0].min[fancy_names_index["Zrot"], MILIEU:] = -0.1  # pas de vrille dans cette phase
    x_bounds[0].max[fancy_names_index["Zrot"], MILIEU:] = 0.1
    ...
    # x_bounds[0].max[fancy_names_index["XrotC"], FIN] = -2.35 #min du model
    ...
    x_bounds[0].min[fancy_names_index["vX"] : fancy_names_index["vY"] + 1, DEBUT] = -0.5
    x_bounds[0].max[fancy_names_index["vX"] : fancy_names_index["vY"] + 1, DEBUT] = 0.5

    # z bassin
    x_bounds[0].min[fancy_names_index["vZ"], :] = -50
    x_bounds[0].max[fancy_names_index["vZ"], :] = 50
    x_bounds[0].min[fancy_names_index["vZ"], DEBUT] = vzinit - 0.5
    x_bounds[0].max[fancy_names_index["vZ"], DEBUT] = vzinit + 0.5

    # autour de x
    x_bounds[0].min[fancy_names_index["vXrot"], :] = 0.5  # d'apres une observation video
    x_bounds[0].max[
        fancy_names_index["vXrot"], :
    ...
    borne_inf = (
        x_bounds[0].min[fancy_names_index["vX"] : fancy_names_index["vZ"] + 1, DEBUT]
        + np.cross(r, x_bounds[0].min[fancy_names_index["vXrot"] : fancy_names_index["vZrot"] + 1, DEBUT])
    )[0]
    borne_sup = (
        x_bounds[0].max[fancy_names_index["vX"] : fancy_names_index["vZ"] + 1, DEBUT]
        + np.cross(r, x_bounds[0].max[fancy_names_index["vXrot"] : fancy_names_index["vZrot"] + 1, DEBUT])
    )[0]
    x_bounds[0].min[fancy_names_index["vX"] : fancy_names_index["vZ"] + 1, DEBUT] = (
    ...
    # deplacement
    x_bounds[1].min[fancy_names_index["X"], :] = -0.1
    x_bounds[1].max[fancy_names_index["X"], :] = 0.1
    x_bounds[1].min[fancy_names_index["Y"], :] = -1.0
    x_bounds[1].max[fancy_names_index["Y"], :] = 1.0
    ...
    x_bounds[1].max[fancy_names_index["Xrot"], :] = 4 * 3.14 - 0.50
    x_bounds[1].min[fancy_names_index["Xrot"], FIN] = 2 * 3.14 - 0.1
    ...
    # la vrille autour de z
    x_bounds[1].min[fancy_names_index["Zrot"], :] = -0.1
    x_bounds[1].max[fancy_names_index["Zrot"], :] = 0.1
    ...
    # deplacement
    x_bounds[2].min[fancy_names_index["X"], :] = -0.2
    x_bounds[2].max[fancy_names_index["X"], :] = 0.2
    x_bounds[2].min[fancy_names_index["Y"], :] = -1.0
    x_bounds[2].max[fancy_names_index["Y"], :] = 1.0
    ...
    # le salto autour de x
    x_bounds[2].min[fancy_names_index["Xrot"], :] = 2 * 3.14 + 0.1  # 1 salto 3/4
    x_bounds[2].max[fancy_names_index["Xrot"], :] = 4 * 3.14 - 0.50
    ...
    x_bounds[2].max[fancy_names_index["Zrot"], :] = 3.14  # 3 * 3.14
    ...
    # deplacement
    x_bounds[3].min[fancy_names_index["X"], :] = -0.2
    x_bounds[3].max[fancy_names_index["X"], :] = 0.2
    x_bounds[3].min[fancy_names_index["Y"], :] = -1.0
    x_bounds[3].max[fancy_names_index["Y"], :] = 1.0
    ...
    # le salto autour de x
    x_bounds[3].min[fancy_names_index["Xrot"], :] = 2 * 3.14 - 0.1
    x_bounds[3].max[fancy_names_index["Xrot"], :] = 2 * 3.14 + 3 / 2 * 3.14 + 0.1  # 1 salto 3/4
    x_bounds[3].min[fancy_names_index["Xrot"], FIN] = 2 * 3.14 + 3 / 2 * 3.14 - 0.1
    x_bounds[3].max[fancy_names_index["Xrot"], FIN] = 2 * 3.14 + 3 / 2 * 3.14 + 0.1  # 1 salto 3/4
    ...
    x_bounds[3].min[fancy_names_index["Zrot"], FIN] = 3 * 3.14 - 0.1  # complete la vrille
    x_bounds[3].max[fancy_names_index["Zrot"], FIN] = 3 * 3.14 + 0.1
    ...
    # deplacement
    x_bounds[4].min[fancy_names_index["X"], :] = -0.1
    x_bounds[4].max[fancy_names_index["X"], :] = 0.1
    x_bounds[4].min[fancy_names_index["Y"], FIN] = -0.1
    x_bounds[4].max[fancy_names_index["Y"], FIN] = 0.1
    x_bounds[4].min[fancy_names_index["Z"], :] = 0
    x_bounds[4].max[
        fancy_names_index["Z"], :
    ] = zmax  # beaucoup plus que necessaire, juste pour que la parabole fonctionne
    x_bounds[4].min[fancy_names_index["Z"], FIN] = 0
    x_bounds[4].max[fancy_names_index["Z"], FIN] = 0.1

    # le salto autour de x
    x_bounds[4].min[fancy_names_index["Xrot"], :] = 2 * 3.14 + 3 / 2 * 3.14 - 0.2  # penche vers avant -> moins de salto
    x_bounds[4].max[fancy_names_index["Xrot"], :] = -0.50 + 4 * 3.14  # un peu carpe a la fin
    x_bounds[4].min[fancy_names_index["Xrot"], FIN] = -0.50 + 4 * 3.14 - 0.1
    x_bounds[4].max[fancy_names_index["Xrot"], FIN] = -0.50 + 4 * 3.14 + 0.1  # 2 salto fin un peu carpe
    ...
    # la vrille autour de z
    x_bounds[4].min[fancy_names_index["Zrot"], :] = 3 * 3.14 - 0.1  # complete la vrille
    x_bounds[4].max[fancy_names_index["Zrot"], :] = 3 * 3.14 + 0.1
    ...
    # z bassin
    x_bounds[4].min[fancy_names_index["vZ"], :] = -50
    x_bounds[4].max[fancy_names_index["vZ"], :] = 50

    # autour de x
    x_bounds[4].min[fancy_names_index["vXrot"], :] = -50
    x_bounds[4].max[fancy_names_index["vXrot"], :] = 50

    # autour de y
    x_bounds[4].min[fancy_names_index["vYrot"], :] = -50
    x_bounds[4].max[fancy_names_index["vYrot"], :] = 50

    # autour de z
    x_bounds[4].min[fancy_names_index["vZrot"], :] = -50
    x_bounds[4].max[fancy_names_index["vZrot"], :] = 50
...
def set_x_init(biorbd_model, fancy_names_index):
    ...
    x5 = np.vstack((np.zeros((nb_q, 2)), np.zeros((nb_qdot, 2))))
    x6 = np.vstack((np.zeros((nb_q, 2)), np.zeros((nb_qdot, 2))))
    x7 = np.vstack((np.zeros((nb_q, 2)), np.zeros((nb_qdot, 2))))
    x8 = np.vstack((np.zeros((nb_q, 2)), np.zeros((nb_qdot, 2))))
    x9 = np.vstack((np.zeros((nb_q, 2)), np.zeros((nb_qdot, 2))))

    x0[fancy_names_index["Xrot"], 0] = 0.50
...
def prepare_ocp(
    ...
    ## JeCh
    objective_functions.add(
        ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="qddot_joints", node=Node.ALL_SHOOTING, weight=1, phase=5
    )
    objective_functions.add(
        ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="qddot_joints", node=Node.ALL_SHOOTING, weight=1, phase=6
    )
    objective_functions.add(
        ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="qddot_joints", node=Node.ALL_SHOOTING, weight=1, phase=7
    )
    objective_functions.add(
        ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="qddot_joints", node=Node.ALL_SHOOTING, weight=1, phase=8
    )
    objective_functions.add(
        ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="qddot_joints", node=Node.ALL_SHOOTING, weight=1, phase=9
    )
    ...
    les_bras = [
        fancy_names_index["ZrotBD"],
        fancy_names_index["YrotBD"],
        fancy_names_index["ZrotABD"],
        fancy_names_index["XrotABD"],
        fancy_names_index["ZrotBG"],
        fancy_names_index["YrotBG"],
        fancy_names_index["ZrotABG"],
        fancy_names_index["XrotABG"],
    ]
    les_coudes = [
        fancy_names_index["ZrotABD"],
        fancy_names_index["XrotABD"],
    ...
    for phase in range(5):
        for node in range(n_shooting[phase]):
            multinode_constraints.add(
                MultinodeConstraintFcn.CONTROLS_EQUALITY,
                phase_first_idx=phase,
                phase_second_idx=phase + 5,
                first_node=node,
                second_node=node,
                key="all",
            )
    #  multinode = []
    # multinode_constraint.add(multinode_constraint=multinode_constraint)

    # constraints.add(ConstraintFcn.node_equalities)
...
def main():
    model_path_AuJo = "Models/AuJo_2.bioMod"
    ...
    #               40, 100, 100, 100, 40)
    n_shooting = (3, 5, 5, 5, 5, 3, 5, 5, 5, 3)
    ...
    if save_sol_FLAG:  # switch manuelle
        np.save(f"Solutions_multiModel_constraints/{nom}-{str(n_shooting).replace(', ', '_')}-{temps}-q.npy", qs)
        np.save(f"Solutions_multiModel_constraints/{nom}-{str(n_shooting).replace(', ', '_')}-{temps}-qdot.npy", qdots)
        np.save(
            f"Solutions_multiModel_constraints/{nom}-{str(n_shooting).replace(', ', '_')}-{temps}-t.npy", sol.phase_time
        )
